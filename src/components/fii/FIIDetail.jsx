...
function calcInvestmentSimulation(stockHistory, ibovHistory, divYield = 0, reinvest = true) {
  ...
  for (let i = 1; i < recentStock.length; i++) {
    ...
    currentStock = currentStock * (1 + returnStock + monthlyYield);
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '24px', flexWrap: 'wrap', gap: '16px' }}>
              ...
              <div style={{ display: 'flex', gap: '16px' }}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
                  <span style={{ fontSize: '12px', color: 'var(--text-secondary)', textTransform: 'uppercase', fontWeight: 600 }}>{fii.ticker}</span>
            ...
            <div style={{ width: '100%', height: '300px' }}>
              <ResponsiveContainer width="100%" height="100%">
                <ComposedChart data={simulation.data} margin={{ top: 10, right: 0, left: -20, bottom: 0 }}>
                  <defs>
                    <linearGradient id="strokeGradientFII" x1="0" y1="0" x2="1" y2="0">
